  ...
  return (
    <View className="bg-[#181e25] flex-1 pt-0 relative">
      ...
      <View className="flex-1 pb-3 overflow-hidden bg-white rounded-t-3xl items-center">
        ...
        <Text className="font-bold text-gray-800 mt-3">Téléchargez votre document de contribuable</Text>
        <Text className="text-center text-gray-400 text-sm">
          Téléchargez ou prenez une photo de votre document
          de contribuable
        </Text>
        ...
        >
          ...
          <Text className="text-sm text-center text-white font-bold">Cliquez ici pour importer le document NIU</Text>
        </TouchableOpacity>

        <Text className="text-center my-4 text-gray-600">------ Ou ------</Text>
        ...
        >
          ...
          <Text className="text-sm text-center text-white">Ouvrez l'appareil photo pour prendre une photo</Text>
        </TouchableOpacity>
        ...
        >
          <Text className="text-xl text-center font-bold ">TERMINEZ</Text>
        </TouchableOpacity>
      </View>
