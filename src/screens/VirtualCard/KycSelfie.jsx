      ...
      <View className="flex-1 bg-white rounded-t-3xl">
        ...
        >
          <View className="items-center pt-3">
            ...
            <Text className="text-center text-gray-400 text-sm px-6">
            ...
            <View className="w-[89%] mx-auto px-6">
              {t("kycSelfie.tips", { returnObjects: true }).map(
                (tip, index) => (
            ...
            <TouchableOpacity
              className="mt-6 mb-6 bg-[#7ddd7d] py-3 rounded-full w-[85%] mx-auto"
              onPress={handleNext}
            >
